  ...
  return (
    <div className="relative z-50" ref={dropdownRef}>
      ...
      >
        ...
        {/* Unread Badge */}
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 inline-flex items-center justify-center min-w-[20px] h-5 px-1 text-xs font-bold text-white bg-orange-500 rounded-full">
